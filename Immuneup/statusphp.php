  ...
  <body class="u-body"><header class="u-clearfix u-custom-color-5 u-header u-header" id="sec-23bd"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-custom-color-7 u-section-1" id="sec-4bae">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <legend style="background-color: gray; color: white; padding: 5px 10px;" > VACCINATION STATUS </legend>
        <h4 class="u-text u-text-default u-text-1">
          <span style="font-weight: 700;">NAME : <?php echo $_SESSION['name']; ?></span>
        </h4>
        <br>
        <h4 class="u-text u-text-default u-text-2">
          <span style="font-weight: 700; font-size: 1.5rem;">Aadhar Number : <?php echo $_SESSION['aadhar']; ?></span>
        </h4>
        <br>
        <h4 class="u-text u-text-default u-text-3">
          <span style="font-weight: 700; font-size: 1.5rem;">Status: Vaccinated </span>
        </h4>
        <?php
      ...
      $aadhar=  $_SESSION['aadhar'];
        ...
        $query = "SELECT * FROM booking WHERE aadhar='$aadhar'";
        ...
        if($total!=0)
        {
          while($result=mysqli_fetch_assoc($data))
          {
            ?>
            <h4 class="u-text u-text-default u-text-3">
              <span style="font-weight: 700; font-size: 1.5rem;"> Slot : <?php echo $result['slot']; ?> </span>
            </h4>
            <h4 class="u-text u-text-default u-text-3">
              <span style="font-weight: 700; font-size: 1.5rem;"> Date : <?php echo $result['vdate']; ?> </span>
            </h4>
