...
<br>
        <div class="form1" style="">
          <form action="#" method="post">
            <label for="pin"> City : &nbsp &nbsp &nbsp &nbsp </label>
           ...
           <div class="main-div">
              <h1>List Of Vaccination Centres</h1>
              <br>
              <br>
            ...
            //           echo "coonection succ";
                       ...
                       $pin=$_POST['pin'];
                     $selectquery = "SELECT * FROM hospital WHERE pin=$pin";
        ...
        <div class="form1">
          <form class="" action="booking.php" method="post">
            ...
            <input type="date" id="start" name="vdate"  max="2021-12-31">
            <br><br>
            <input type="submit" name="save" class="submit1">
      ...
      <br>
      <br>
    <footer class="copyrightText"  id="sec-43fa"><div class="u-clearfix u-sheet u-sheet-1">
        <p>Copyright&nbsp; @ 2021 , All rights reserved&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        Privacy Poliicy | Terms and Condtion&nbsp;&nbsp;</p>
      </div></footer>
