    ...
    <section class="u-clearfix u-custom-color-7 u-section-1" id="sec-30b6">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="feedback.php" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" source="custom" name="form">
            <div class="u-form-group u-form-name">
              <label for="name-6797" class="u-form-control-hidden u-label">Name</label>
              <input type="text" placeholder="Name"  name="name" class="u-border-1 u-border-black u-input u-input-rectangle u-text-black u-input-1" required="">
            </div>
            <div class="u-form-group">
              <label for="email-6797" class="u-form-control-hidden u-label">Email</label>
              <input type="text" placeholder="Aadhar Number"  name="aadhar" class="u-border-1 u-border-black u-input u-input-rectangle u-text-black u-input-2" required="required">
            </div>
            <div class="u-form-group u-form-message">
              <label for="message-6797" class="u-form-control-hidden u-label">Address</label>
              <textarea placeholder="Feedback/Query" rows="6" cols="50" name="message" class="u-border-1 u-border-black u-input u-input-rectangle u-text-black u-input-3" required=""></textarea>
            </div>
            <div class="u-align-center u-form-group u-form-submit">
              <a href="Homephp.php" class="u-btn u-btn-submit u-button-style u-custom-color-5 u-hover-custom-color-8 u-btn-1">Submit</a>
              <input type="submit" value="submit" action="Homephp.php" class="u-form-control-hidden">
            </div>
