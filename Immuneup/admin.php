  ...
  <body class="u-body"><header class="u-clearfix u-custom-color-5 u-header u-header" id="sec-23bd"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-left u-clearfix u-image u-shading u-section-1" src="" id="sec-db76" data-image-width="1003" data-image-height="1280">
      <div class="u-form u-form-1">
        <form action="adminlogin.php" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 11px;" source="custom" name="form" redirect="true">
          <div class="u-form-group">
            <label for="email-11c8" class="u-form-control-hidden u-label u-text-black u-label-1">Email</label>
            <input type="text" placeholder="Enter your Full Name"  name="name" class="u-border-1 u-border-black u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-text-body-color u-text-font u-input-1" required="required">
          </div>
