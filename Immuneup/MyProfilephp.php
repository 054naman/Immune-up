                ...
                <div class="u-container-layout u-container-layout-2">
                  ...
                  <p class="u-text u-text-3">
                    <span style="font-size: 1.875rem;">
                      <span style="font-weight: 700;">Name:&nbsp;&nbsp;</span><?php echo $_SESSION['name']; ?><br>
                      <span style="font-weight: 700;">Aadhar Number:&nbsp; <span style="font-weight: 400;"><?php  echo $_SESSION['aadhar']; ?></span>
                      </span>
                      <span style="font-weight: 700;">
                        <br>Gender:<span style="font-weight: 400;"> <?php echo $_SESSION['gender']; ?></span>
                      </span>
                    </span>
                    <br>'
                  </p>
